...
@section('content')
    ...
    <form method="POST" action="{{ route('admin.articles.update',$article)}}" enctype="multipart/form-data">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-4">
                <textarea id="content" class="form-control{{ $errors->has('content') ? ' is-invalid' : '' }}" name="content" autofocus required>{{$article->content}}</textarea>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-4">
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="publication_status" id="online-status" value="online" required {{  $article->publication_date ? 'checked' : '' }}>
                    <label class="form-check-label" for="online-status">
                        Online
                    </label>
                    </div>
                    <div class="form-check">
                    <input class="form-check-input" type="radio" name="publication_status" id="offline-status" value="offline" {{ !$article->publication_date ? 'checked' : '' }}>
